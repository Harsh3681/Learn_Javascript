...
/* Mainly when u have been decleared the class and inside it there is some 
    ...
    so
    using #️⃣"#" <--- symbol we decleared variable as "Private"
...
//  We can't directly access an private field from class like above her the " #radius" is private field. 
// For that we need to create "funct" which will help us access private variable through it.
//  Like here we define 👉"myAccessor" funct

let circle = new Circle(10);
// console(circle.radius);  // ERRPR ❌
console.log("My radius ",circle.myAccessor());  // Correct ✅
...
class Cylinder extends Circle {
    ...
    constructor(radius, height) {
      super(radius);
      this.#height = height;
    //   this.#radius = radius;   // cannot access the #radius of the Circle class here hence we use 👉 "super()" funct
      
    }
}

const area = new Cylinder(3,2);  // here "area" is "Obj" and we create instant of "Cylinder" class
...
class myCircle2 {
    ...
    static hasRadius(circle) { // it an "boolan" funt 👈
...
let circles = [new myCircle2(10), new myCircle2(20), new myCircle2(30)]; // assigned radius 3 time // means 3 obj has created
