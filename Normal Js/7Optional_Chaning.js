...
//  optional chaning is used to check if the property is present or not in the object . using operator (?.)
...
// console.log(hey.add.newStreet);  // it generate an error because add property is not present in hey object to overcome this we use optional chaning like above "?" symbol like above
